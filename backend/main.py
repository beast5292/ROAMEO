...
cred = credentials.Certificate(r'C:\Users\sulai\Downloads\Latest_main (2)\Latest_main\ROAMEO\backend\private key\roameo-f3ab0-firebase-adminsdk-ss40k-1e1297f52f.json') 
initialize_app(cred)
