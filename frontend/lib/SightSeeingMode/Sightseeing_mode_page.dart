  ...
  class _SsmPageState extends State<SsmPage> {
    ...
    void initState() {
      ...
      // Load the dark mode style JSON file after the widget is built.
    ...
    // Request current location and set initial camera position.
    ...
    // Re-align the camera by resetting the bearing to 0 for the current center.
